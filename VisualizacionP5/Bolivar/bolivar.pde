...
void drawPorcentage() 
{
  ...
  fill(#2D11ED);
  //text(suba[valSlider]+" suba", 120, 280);
  textSize(20);
  text("Ciudad Bolivar = "+bolivar[valSlider]+" casos", 845, 650);
  //text("Número de casos", 120, 300);
  //text("kennedy = " +kennedy[valSlider]+ " casos", 845, 650);
  
  pixelSteps = int(map(bolivar[valSlider],19,40,25,9)); //cantidad segun el excel
